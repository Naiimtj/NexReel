...
const PAGES = ['Home', 'Movies', 'TV Shows', 'Profile'];
const LINKS = ['Forum', 'Settings', 'FAQs', 'Help'];
      ...
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 lg:justify-between">
        ...
        <div className="flex justify-center">
          {SOCIAL_PATHS.map((d, i) => (
            <a key={d.slice(0, 12)} className={`${i < SOCIAL_PATHS.length - 1 ? 'mr-6' : ''} text-grayNR`}>
              <svg
      ...
      <div className="py-5 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div>
            ...
            {LINKS.map((l) => (
              <p key={l} className="mb-4 last:mb-0">
                <a className="text-grayNR">{l}</a>
              </p>
            ))}
          </div>
        </div>
