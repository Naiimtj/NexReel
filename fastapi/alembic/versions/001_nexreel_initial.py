"""Initial NexReel PostgreSQL schema.

Revision ID: 001_nexreel_initial
Revises:
...
revision: str = "001_nexreel_initial"
...
DOWNGRADE_STATEMENTS = [
    "DROP INDEX IF EXISTS idx_plex_tv_rating_key",
    "DROP INDEX IF EXISTS idx_plex_movie_rating_key",
    "DROP INDEX IF EXISTS idx_messages_users_lookup",
    "DROP INDEX IF EXISTS idx_messages_forum_id",
    "DROP INDEX IF EXISTS idx_forum_followers_forum_id",
    "DROP INDEX IF EXISTS idx_playlist_followers_playlist_id",
    "DROP INDEX IF EXISTS idx_media_tv_episodes_lookup",
    "DROP INDEX IF EXISTS idx_media_tv_seasons_lookup",
    "DROP INDEX IF EXISTS idx_media_tv_user_id",
    "DROP INDEX IF EXISTS idx_media_user_id",
    "DROP INDEX IF EXISTS idx_user_followers_following_id",
    "DROP TABLE IF EXISTS plex_tv",
    "DROP TABLE IF EXISTS plex_movie",
    "DROP TABLE IF EXISTS plex_data",
    "DROP TABLE IF EXISTS messages",
    "DROP TABLE IF EXISTS forum_followers",
    "DROP TABLE IF EXISTS forums",
    "DROP TABLE IF EXISTS playlist_followers",
    "DROP TABLE IF EXISTS playlists",
    "DROP TABLE IF EXISTS media_tv_episodes",
    "DROP TABLE IF EXISTS media_tv_seasons",
    "DROP TABLE IF EXISTS media_tv",
